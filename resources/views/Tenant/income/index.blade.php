...
<section>
    <div class="container-fluid">
        <div class="card">
            ...
            <button class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> {{trans('file.Add Income')}}</button>
    </div>
    <div class="table-responsive">
        <table id="income-table" class="table income-list" style="width: 100%">
            ...
            @foreach($incomes as $key=>$income)
                <tr data-purchase='@json($income)'>
                    <td>{{ $key}}</td>
                    <td>{{ \Carbon\Carbon::parse($income->created_at)->format(config('date_format')) }}</td>
                    <td>{{ $income->reference_no }}</td>
                    <td>{{ $income->warehouse->name }}</td>
                    <td>{{ $income->incomeCategory->name }}</td>
                    <td>{{ number_format($income->amount, config('decimal')) }}</td>
                    <td>{{ $income->note }}</td>
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <button type="button" data-id="{{$income->id}}" class="open-Editexpense_categoryDialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i>{{trans('file.edit')}}</button>
                                </li>
                                <li>
                                    <form action="{{ route('incomes.destroy', $income->id) }}" method="POST" onsubmit="return confirmDelete()">
                                        @csrf
                                        @method('DELETE')
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                ...
                <?php
                    $lims_income_category_list = DB::table('income_categories')->get();
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <select name="income_category_id" class="selectpicker form-control" required data-live-search="true" data-live-search-style="begins" title="Select Expense Category...">
                            @foreach($lims_income_category_list as $expense_category)
